...
export interface ButtonProps<T extends React.ElementType = "button">
  extends React.HTMLAttributes<T>, VariantProps<typeof buttonVariants> {
  as?: T;
  asChild?: boolean;
  disabled?: boolean;
  normalCase?: boolean;
  ...
  return (
    <Comp
      className={cn(
        ...
        "before:transition-all before:duration-200 before:[transition-timing-function:cubic-bezier(.23,1,.32,1)] hover:before:-top-1/2",
