...
export const MAP_ITEMS: MapLevel[] = [
  {
    ...
    nodes: [
      { name: "Strefa Wyłączona", color: "#CD2E32" },
      { name: "Scena Plenerowa", color: "#D2CBA3" },
      { name: "Zaplecze Techniczne", color: "#5F6EB6" },
      { name: "Gastro", color: "#BBE880" },
      { name: "Partnerzy/Atrakcje", color: "#CB6BA9" },
    ],
  },
];
