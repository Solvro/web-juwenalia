...
// Tymczasowo wyłączona możliwość wyboru typów map
...
export function Map({ dynamicMapLocations }: Props) {
  // Tymczasowo wyłączony selektor typu mapy
  ...
  return (
    <div className="relative mt-16 pb-32">
      ...
      <PaddingWrapper className="relative">
        ...
        {/* Tymczasowo wyłączony wybór typu mapy */}
        ...
        {/* Tymczasowo wyłączone warunkowe renderowanie map */}
        {/* {selectedIndex === 0 ? (
          <StaticMap />
        ) : ( */}
        <Suspense
